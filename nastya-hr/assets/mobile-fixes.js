(function(){
  ...
  var paths={
    dark:"assets/brand/logo-anasteysha-mark-dark.png?v="+assetVersion,
    light:"assets/brand/logo-anasteysha-mark-light.png?v="+assetVersion,
    fallback:"assets/brand/icon-192.png?v="+assetVersion
  };
